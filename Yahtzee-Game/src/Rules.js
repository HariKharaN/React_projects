...
class SmallStraight extends Rule {
  evalRoll = (dice) => {
    ...
    // small sharight has  2 3 4 either 1 or 5 like '1'234 or 234'5'
    if (d.has(2) && d.has(3) && d.has(4) && (d.has(1) || d.has(5)))
      return this.score;
    // 3 4 5 and either 6 or 2 like 345'6' or '2'345
...
const smallStraight = new SmallStraight({
  score: 30,
  description: "30 points for a small sharight",
});
const largeStraight = new LargeStraight({
  score: 40,
  description: "40 points for a small sharight",
});

// yahtzee scores as 50
const yahtzee = new Yahtzee({
  score: 50,
  description: "50 point for a yahtzee",
});
